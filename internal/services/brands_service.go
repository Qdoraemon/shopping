...
func (bs *BrandService) GetBrandByPage(request models.SearchBrandsRequest) (models.SearchBrandsResponse, error) {
	brands, total, err := bs.BrandRepo.GetBrandByPage(request)

	if err != nil {
		return models.SearchBrandsResponse{
			Brands: nil,
			Total:  0,
		}, err
	}
...
func (bs *BrandService) DeleteBrand(id string) error {
